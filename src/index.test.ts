...
describe('package public exports', () => {
  it('exposes every resource factory and the top-level createClient', () => {
    ...
    expect(sdk.createPublicChargesClient).toBeTypeOf('function')
    expect(sdk.getPublicCharge).toBeTypeOf('function')
    expect(sdk.createOrganizationClient).toBeTypeOf('function')
  ...
  it('exposes every error class', () => {
    ...
    expect(sdk.ChargeCanceledError).toBeTypeOf('function')
